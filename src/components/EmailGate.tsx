    ...
    try {
      ...
      if (contentType && contentType.includes("application/json")) {
        try {
          ...
          // Ignore parse errors on bad JSON format
        }
      }

      if (!response.ok) {
        console.warn("Proxy registration alert:", (result && result.message) || "Generic failure");
    ...
    >
      ...
      >
        ...
        <p className="text-zinc-300 text-sm sm:text-base leading-relaxed mb-8 max-w-sm">
          Enter your email below to connect with your spirit wolf and discover the important role you play in the pack.
        </p>
        ...
        <p className="text-zinc-500 text-[10px] font-sans tracking-wide leading-relaxed mt-6">
          Your privacy is protected. By submitting, you agree to receive emails from the pack such as wolf conservation updates and spirit wolf insights. No spam. Unsubscribe anytime. Please review our <a href="https://www.hellowiah.com/private-policy" target="_blank" rel="noopener noreferrer" className="underline hover:text-zinc-350 transition-colors">Privacy Policy</a>.
        </p>
      </motion.div>
